...
class SevenSceneSequence:
    def __init__(
        ...
        self.predict_pose_path = predict_pose_path
        ...
        for name in frame_names:
            ...
            pose_path = osp.join(predict_pose_path, f"{name}.pose.txt")
            # print(pose_path)
            # input()
...
def seq2ply(seq_dir_path, predict_pose_path, ply_path, kf_every = 1, crop_size = None, voxel_grid_size = None):
    """
    ...
    seq = SevenSceneSequence(seq_dir_path = seq_dir_path, predict_pose_path = predict_pose_path)  
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Convert sequence to ply")
    ...
    parser.add_argument('--voxel_grid_size', type=float, default=7.5e-3, help='Voxel grid size for downsampling the point cloud')
    ...
    # print(kf_every, type(kf_every))
    # print(voxel_grid_size, type(voxel_grid_size))
    # input()
    seq2ply(sequence_path, predict_pose_path, ply_path, kf_every = kf_every, voxel_grid_size = voxel_grid_size) 
